...
3. Search for `Text Domain: jeffpack-theme` in style.css.
...
* Search for: `Text Domain: jeffpack-theme` and replace with: `Text Domain: megatherium-is-awesome` in style.css.
