...
// require_once( WP_PLUGIN_DIR.'/jeffpack-for-wordpress/jeffpack-lib/WpThemeBase.php');
// class JeffpackParchment extends WpThemeBase {}
// $jeffpack_parchment = new JeffpackParchment();
